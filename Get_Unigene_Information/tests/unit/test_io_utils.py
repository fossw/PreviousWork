...
"""Runs various tests on io_utils from ggli to check for proper function"""
...
INVALID_GENE_FILE = "test_species.unigene"
...
def test_is_gene_file_valid():
    ...
    # tests if the function can accurately assess the validity of a gene file

    io_utils.is_gene_file_valid(INVALID_GENE_FILE)
